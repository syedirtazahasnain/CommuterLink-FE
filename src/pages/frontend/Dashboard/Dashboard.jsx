          ...
          >
            ...
            <div className="col-lg-9 px-5">
              ...
              >
                ...
                <div className="card" style={{ border: "1",backgroundColor:"#D9D9D9" }}>
                  <div class="card-header bg-dark mb-2">
                    <h3 className="text-center text-white m-auto"> MY TRAVEL PARTNERS </h3>
                  </div>
                                ...
                                <div className="col-4 mx-2">
                                  ...
                                  >
                                    <div
                                      ...
                                      style={{ backgroundColor: "#2a402a" }}
                                    >
                                      <h4 className="text-center m-auto">MY WALLET</h4>
                                    </div>
                                  </div>
                                  <div className="row d-flex justify-content-between ">
                ...
                <div className="card" style={{ border: "1", backgroundColor:"#D9D9D9"}}>
                  <div class="card-header bg-dark mb-2">
                    <h3 className="text-center text-white m-auto">TRAVEL CONFIRMATION</h3>
                  </div>
                  <div className="row d-flex m-auto" >
                    <div className="col-12">
                      <div className="card rounded-4">
