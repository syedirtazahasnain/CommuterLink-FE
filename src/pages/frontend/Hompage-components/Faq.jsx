          ...
          <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
              <div className="card-body small-text ">
                ...
                <ul className="list-unstyled">
                    <li className="d-flex"><i class="bx bx-chevron-right"></i>CommutersLink is not a money making mechanism but follows the concept of saving through sharing. Unlike other Apps, it’s not means to earn for driver/car owner but to save the cost by distributing it amongst travel buddies
                    </li>
                    <li className="d-flex"><i class="bx bx-chevron-right"></i>
          ...
          <div id="collapseTwo" className="collapse " aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body small-text">
                CommutersLink has an internal Artificial Intelligence based cost calculator. It takes into account following factors and then works out cost per seat per day.
                 <ul className="list-unstyled">
                    <li className="d-flex"><i className="bx bx-chevron-right"></i>Car model, make and Type
                    </li>
                    <li className="d-flex"><i className="bx bx-chevron-right"></i>Average fuel consumption of a particular car type
                    </li>
                    <li className="d-flex"><i classNameName="bx bx-chevron-right"></i>
                        Distance to be traversed (this will include distances covered by car owner to pick up and drop off points of travel buddies )
                    </li>
                    <li className="d-flex"><i className="bx bx-chevron-right"></i>Routine maintenance (oil change etc.)
                    </li>
                    <li className="d-flex"><i className="bx bx-chevron-right"></i>Wear and Tear of the Car
                    </li>
                    <li className="d-flex"><i className="bx bx-chevron-right"></i>5% service of CommutersLink
                    </li>
                </ul>
                </div>
            </div>
