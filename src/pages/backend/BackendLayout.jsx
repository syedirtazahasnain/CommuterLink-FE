                                ...
                                <div className="text-end d-none d-sm-flex flex-column justify-content-start py-2">
                                  <div className="align-self-end lead">
                                    <div className="d-block">
                                      ...
                                      <p className="fw-bold font-custom fs-7 text-dark">{option === 0 ? (<h6 className="fs-6 fw-bold font-custom">Traveller</h6>) : (<h6 className="fs-6 font-custom fw-bold">Car Offeror</h6>)}</p>
                                    </div>
                                  </div>
                                </div>
