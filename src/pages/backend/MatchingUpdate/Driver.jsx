...
const Driver = () => {
    ...
    const [carcc, setCarCC] = React.useState('');
    const [carmodel, setCarModel] = React.useState('');
    const [carregistration, setCarRegistration] = React.useState('');
                    ...
                    <div className="card-body text-dark">
                        <div className="container text-center">
                            ...
                            <Form className="text-center">
                                ...
                                <Box sx={{ minWidth: 120, color: 'success' }} className="mb-3">
                                    <FormControl fullWidth size="small">
                                        <InputLabel id="demo-simple-select-label" color='success'>Car Model</InputLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id="demo-simple-select"
                                            color='success'
