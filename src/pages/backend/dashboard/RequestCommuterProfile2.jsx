          ...
          <div className="row">
            {profiles.length > 0 && userProfileDetails.length > 0 ? (
              profiles
                ...
                .map((profile, index) => {
                  return <UserProfileCard profile={profile} key={index} userDetails={userProfileDetails[index]} />;
                })
            ) : (
              null
            )}
...
export default RequestCommuterProfile2;
