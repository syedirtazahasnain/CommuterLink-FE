                ...
                >
                  ...
                  {/*end::Info*/}
                    ...
                    <div className="menu-item">
                      <Link
                        className={`menu-link ${
                          currentPage == "insights-generator" ? "active" : ""
                        }`}
                  ...
                  <div
                    className={
                      sidebarOpened ? "text-center mt-auto" : "px-7 mt-auto"
                    }
                  >
          ...
          >
            ...
            <div className="col-lg-9 px-5">
              ...
              >
                ...
                <div className="card" style={{ border: "1",backgroundColor:"#D9D9D9" }}>
                  ...
                  <div className="row d-flex m-auto">
                    <div className="col-12">
                      <div className="card rounded-4">
                        ...
                        >
                          <h4 className="m-auto text-white">COMMUTERSLINK SUGGESTIONS</h4>
                        </div>
                        <div className="card-body" style={{backgroundColor:"#D9D9D9"}}>
                          <p className="card-title text-center">
                            Based upon your Profile, We have Following <span className="fs-5 fw-bold">Matches </span>
                            to Offer
                          </p>
                          <div
                            className="card m-auto border-0"
                            style={{ width: "50rem",backgroundColor:"#D9D9D9" }}
                          >
                    ...
                    <div className="col-12">
                      <div className="card rounded-4">
                        <div
                          ...
                          style={{ backgroundColor: "#2a402a" }}
                        >
                          <h4 className="m-auto text-white">REQUESTS BY MEMBERS</h4>
                        </div>
                        <div className="card-body" style={{backgroundColor:"#D9D9D9"}}>
                          <p className="card-title text-center">
                            Based upon your Profile, We have Following <span className="fs-5 fw-bold">Requests </span>
                            to Offer
                          </p>
                          <div
                            className="card m-auto border-0"
                ...
                <div className="card" style={{ border: "1",backgroundColor:"#D9D9D9" }}>
                  <div class="card-header bg-dark mb-2">
                    <h3 className="text-center text-warning m-auto"> MY TRAVEL PARTNERS </h3>
                  </div>
                  <div className="row m-auto">
                    <div className="col-12">
                      <div className="card rounded-4 border-1" style={{backgroundColor:"#D9D9D9"}}>
                      ...
                      <div className="card rounded-4">
                        <div className="card-body" style={{backgroundColor:"#D9D9D9"}}>
                          <div
                            ...
                            style={{ width: "50rem", backgroundColor:"#D9D9D9" }}
                          >
                            <div className="card border-0" style={{backgroundColor:"#D9D9D9"}}>
                              <div className="row d-flex justify-content-between">
                                <div className="col-4 mx-2">
                                  ...
                                  >
                                    <div
                                      ...
                                      style={{ backgroundColor: "#2a402a" }}
                                    >
                                      <h4 className="text-center text-white m-auto">MY WALLET</h4>
                                    </div>
                                  </div>
                                  <div className="row d-flex justify-content-between ">
                                    ...
                                    <div className="col-md-2">
                                      <div
                                        ...
                                        style={{ width: "6rem",backgroundColor:"#D9D9D9" }}
                                      >
                                        {" "}
                                ...
                                <div className="col-6">
                                  <div
                                    className="card mx-3"
                                    style={{ width: "20rem", backgroundColor:"#D9D9D9" }}
                                  >
                                    <div
                                    ...
                                    <div className="">
                                      <div
                                        ...
                                        style={{ width: "15rem"}}
                                      >
                                        <div class="row d-flex text-center text-success justify-content-center">
                ...
                <div className="card" style={{ border: "1", backgroundColor:"#D9D9D9"}}>
                  <div class="card-header bg-dark mb-2">
                    <h3 className="text-center text-warning m-auto">TRAVEL CONFIRMATION</h3>
                  </div>
                  <div className="row d-flex m-auto" >
                    <div className="col-12">
                      <div className="card rounded-4">
