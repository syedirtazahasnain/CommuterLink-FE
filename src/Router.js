  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/signup"
          element={<FrontendLayout children={<Signup />} />}
        />
        <Route
          path="/login"
        ...
        <Route
          path="/commuterprofile1"
          element={<BackendLayout children={<CommuterProfile1 />} />}
        />
        <Route
          path="/replytoconfirmdates1"
          element={<BackendLayout children={<ReplyToConfirmDates1 />} />}
        />
        <Route
          path="/sendapprovalforpartner1"
          element={<BackendLayout children={<SendApprovalForPartner1 />} />}
        />
        <Route
          path="/sharetocare1"
          element={<BackendLayout children={<ShareToCare1 />} />}
        />
        <Route
          path="/termscondition1"
          element={<BackendLayout children={<TermsCondition1 />} />}
        />
        <Route
          path="/verification1"
          element={<BackendLayout children={<Verification1 />} />}
        />
        <Route
          path="/whyprocesspayment1"
          element={<BackendLayout children={<WhyProcessPayment1 />} />}
        />
        <Route
          path="/new-dashboard"
          element={<BackendLayout children={<CommuterDetails />} />}
        />
        <Route
          path="/requestcarowner"
          element={<BackendLayout children={<RequestApprovalByCarOwner />} />}
        />
        {/* <Route path='/dashboard' element={<BackendLayout children={<Dashboard12 />} />} /> */}
        <Route
          path="/rejection"
          element={<BackendLayout children={<Rejection />} />}
        />
        <Route
          path="/otp"
          element={<FrontendLayout children={<OtpPage />} />}
        />
        <Route
          path="/advancepayment"
          element={<BackendLayout children={<AdvancePayment />} />}
        />
        <Route
          path="/contact"
          element={<BackendLayout children={<Contact />} />}
        />
        <Route
          path="/driver-registration"
          element={<FrontendLayout children={<DriverRegistration />} />}
        />
        <Route
          path="/rider-registration"
          element={<FrontendLayout children={<RiderRegistration />} />}
        />
        <Route
              path="/shareride"
        ...
        {userSignup && (
          <>
            ...
            <Route
              path="/nested"
              element={<FrontendLayout children={<WouldYouLikeTo />} />}
            ></Route>
            <Route
              path="/number-generate"
              element={<FrontendLayout children={<NumberGenerate />} />}
            ></Route>
            <Route
              path="/verification"
              element={<FrontendLayout children={<Verification />} />}
            ></Route>
            <Route
              path="/office_school"
              element={<FrontendLayout children={<Office_School />} />}
            ></Route>
          </>
        )}
        {userLogin && (
          <>
            ...
            <Route
              path="/dashboard"
              element={<BackendLayout children={<Dashboard12 />} />}
            ></Route>
            <Route
              path="/notification"
              element={<BackendLayout children={<Notifications />} />}
            ></Route>
            <Route
            ...
            ></Route>
            <Route
              path="/seatcostverification"
              element={<FrontendLayout children={<SeatCostVerification />} />}
            ></Route>
          </>
        )}
